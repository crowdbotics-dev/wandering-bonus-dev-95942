...
## Project Structure
    ...
    ├── wandering_bonus_dev_95942  # Django project configurations
...
1. Clone this repo and `cd wandering_bonus_dev_95942`
...
2. Clone this repo and `cd wandering_bonus_dev_95942`
